...
public class Game extends Activity implements Observer {	
	...
	private boolean mFirstYourTurn, mCheatsEnabled, mCheatsWin, mCheatsTrash;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (mNumPlayers == 1) mGameEngine.inGame(true);
	}
	...
	protected void onResume() {
		...
		mCheatsTrash = (mPrefs.getBoolean(getResources().getString(R.string.pref_key_cheatsTrashUnlocked), false) &&
				mPrefs.getBoolean(getResources().getString(R.string.pref_key_cheatsTrashUnlocked), false));
		mCheatsEnabled = (mCheatsWin || mCheatsTrash);
